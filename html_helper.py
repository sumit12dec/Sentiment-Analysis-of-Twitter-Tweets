...
class HTMLHelper:
    ...
    def getDefaultHTML(self, error = 0):
        html = '''
<html>
<head><title>Sentiment Analysis of Twitter Data</title>
...
'''
    ...
    <div id='ft'>Developed by Ritesh Kumar, Sameer Kumar Sinha & Sumit Kumar Raj <br/>Under the guidance of Mrs. Madhura M, Asst. Professor<br/>Dept. of Information Science Engineering,Bangalore</div>
        ...
        '''
            ...
            html += '''
                ...
                var options = {
                  ...
                  'colors': ['#ADFF2F','#A9A9A9','#F08080'],
		  'chartArea': {left:0,top:0,width:"150%",height:"225%"}
                };
